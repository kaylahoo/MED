...
if __name__ == "__main__":
    ...
    model.netEN.module.load_state_dict(torch.load("37_net_EN.pth"))
    model.netDE.module.load_state_dict(torch.load("37_net_DE.pth"))
    model.netMEDFE.module.load_state_dict(torch.load("37_net_MEDEF.pth"))
