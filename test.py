...
if __name__ == "__main__":
    ...
    model.netEN.module.load_state_dict(torch.load("/home/lab265/lab265/liulu/MED/checkpoints/psv-pth/Mutual-Encoder-Decoder/33_net_EN.pth")['net'])
    model.netDE.module.load_state_dict(torch.load("/home/lab265/lab265/liulu/MED/checkpoints/psv-pth/Mutual-Encoder-Decoder/33_net_DE.pth")['net'])
    model.netMEDFE.module.load_state_dict(torch.load("/home/lab265/lab265/liulu/MED/checkpoints/psv-pth/Mutual-Encoder-Decoder/33_net_MEDFE.pth")['net'])
